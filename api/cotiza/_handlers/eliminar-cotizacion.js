// POST con auth: elimina (hard delete) una cotización de cotiza_cotizaciones.
// Pensado para limpiar pruebas o cotizaciones duplicadas. La acción es
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error("[/api/cotiza/eliminar-cotizacion]", err?.message ?? err);
